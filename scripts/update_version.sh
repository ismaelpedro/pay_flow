...
if git add . && git commit -m "chore: Increment version to $NEW_VERSION [SCRIPT]" && git push "https://ismaelpedro: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@github.com/ismaelpedro/payflow.git"; then
