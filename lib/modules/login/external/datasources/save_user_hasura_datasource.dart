...
import 'package:pay_flow/core/infra/dtos/user_dto.dart';
...
import '../../infra/interfaces/datasources/i_save_user_hasura_datasource.dart';
...
class SaveUserHasuraDatasource implements ISaveUserDatasource {
  ...
  Future<Either<LoginException, UserEntity>> call(UserEntity user) async {
    try {
      ...
      throw const Left(LoginException());
    }
  }
}
